...
[Part 1. Sorting Algorithms](https://github.com/happya/data-structure-and-algorithms-cpp/tree/master/SortAlgo)
...
>
> 2. 将此时新的根节点和其左右孩子比较：
> 3. 如果比他们都小，那么依旧满足最小堆性质；
> 4. 如果不是最小，和最小的对调，并在对应的子树中逐层检查并维护最小堆的性质。
